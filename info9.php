				...
				<legend>
					<center >
						...
						<div class="row">
							...
							<img class=" mt-4"  src="./image/Logo.png" alt="BPDB" height="80px" width="80px">
							</div>
						...
						<!-- <div class="logo" style="width:10%; height:100%; float:left;">
							<img src="./image/Logo.png" alt="BPDB" height="60px" width="60px">
						</div>
						<div class="title" style="width:90%; height:100%; text-align:center;">
							<h2><b>বাংলাদেশ বিদ্যুৎ উন্নয়ন বোর্ড</b></h2>
							<h6>বিক্রয় ও বিতরণ বিভাগ- স্টেডিয়াম, বিউবো, চট্টগ্রাম ।</h6>
							<h6>নূতন মধ্যচাপ (১১ কেভি) সংযোগ গ্রহণ/ লোড বর্ধিতকরণের সম্মতিপত্র</h6>
							<h6>প্রদানের নিমিত্তে দরখাস্তের সহিত প্রাপ্ত দলিলপত্রের তথ্য বিবরণী ।</h6>
