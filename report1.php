...
<body>
    <section class="header">
        <h1 class="title">বিষয়ঃ বিক্রয় ও বিতরন বিভাগ-স্টেডিয়াম, বিউবো, চট্টগ্রাম এর অধীন ১১ কেজি এইচ-০৪ ফিডারের আওতাধীন মোঃ নূরুল আনোয়ার, পিতাঃ মোঃ নূরুল ইসলাম এর নবনির্মিত ভবন হোল্ডিং নংঃ-১৪, বাটালী রোড, কোতয়ালী, চট্টগ্রাম এর অনূকুলে ১২০ কিলোওয়াট লোড অনুমোদন সহ নতুন মধ্যম চাপ সংযোগ প্রসঙ্গে।</h1>
       ...
       <ul>উপকেন্দ্রের নামঃ <span name="i8" id="i8" style="color: red ;">৩৩/১১ কেভি স্টেডিয়াম উপকেন্দ্র।</span>
       <li>উপকেন্দ্রের ক্ষমতা ঃ <span name="i9" id="i9" style="color: red ;">৩ও ১৬/২০ এমভিএ।</span></li>
       <li>ব্রেকার ক্ষমতা ঃ <span name="i10" id="i10" style="color: red ;">৬৩০ এ্যাম্পস।</span></li>
       <li>ব্রেকার সিটি রেশিও ঃ <span name="i11" id="i11" style="color: red ;">৩০০/৫ এ্যাম্পস।</span></li>
       <li>ফিডারের সর্বোচ্চ লোড ঃ<span name="i12" id="i12" style="color: red ;">  ৪.০ মেঃওঃ।</span></li>
       <li>গ্রাহক প্রšেত্মর ভোল্টেজ ড্রপঃ<span name="i13" id="i13" style="color: red ;"> ২.৬৮%</span></li>
       <li>ফিডারের শেষ প্রšেত্মর ভোল্টেজ ড্রপঃ <span name="i14" id="i14" style="color: red ;">২.৯৮%</span></li>
       </ul>
